...
urlpatterns = [
    ...
    path(
        "staff/products/<slug:slug>/toggle-active/",
        views.staff_product_toggle_active, name="staff_product_toggle_active",
    ),
    path(
        "staff/products/<slug:slug>/delete/",
        views.staff_product_delete, name="staff_product_delete",
    ),
    ...
    path(
        "staff/categories/<slug:slug>/edit/",
        views.staff_category_edit, name="staff_category_edit",
    ),
    path(
        "staff/categories/<slug:slug>/delete/",
        views.staff_category_delete, name="staff_category_delete",
    ),
